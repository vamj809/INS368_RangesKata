//https://docs.google.com/spreadsheets/d/1FUAc_LoRzaDaNzIz5sXDKJFOGCWt0LG2tZQoeX2mFQA/edit?usp=sharing
...
type Range(rangeExpression:string) = 
    class
        ...
        do
            ...
            if(startVal > endVal) then eprintfn "Rango invalido"

            printf "%s " rangeExpression
       
        member this.Contains(inputRange:int[]) =
        ...
        member this.GetAllPoints(inputRange):int[] =
